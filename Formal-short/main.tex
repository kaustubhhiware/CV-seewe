...
\address{\href{mailto:hiwarekaustubh@gmail.com}{ hiwarekaustubh@gmail.com} \\ +91 8768829567 \\ \url{kaustubhhiware.in}} % Your phone number and email
...
B.Tech. \& M.Tech. Hons. in Computer Science \& Engineering \hfill CGPA: 8.42/10\\
\vspace{-1.5em}
...
% \begin{rSubsection}{ \large Deep Learning in Legal Data Analytics}{\textbf{\large July $^{\prime}$18 - Present}}{Masters' Thesis Project under Prof. Saptarshi Ghosh}{CSE Dept. IIT Kharagpur}
...
\vspace{-0.5em}
% \begin{rSubsection}{ \large NARMADA: Need and Availability Resource Matching Assistant for Disasters and Adversities: \href{http://narmada.herokuapp.com}{narmada.herokuapp.com}}{\textbf{\large Aug $^{\prime}$18-Present}}{Research Project under Prof. Saptarshi Ghosh}{CSE Dept. IIT Kharagpur}
...
\vspace{-0.5em}
% \begin{rSubsection}{ \large SAVITR: A System for Real-time Location Extraction from Microblogs during Emergencies: \href{http://savitr.herokuapp.com}{savitr.herokuapp.com}}{\textbf{\large July $^{\prime}$16-April $^{\prime}$17}}{Research Project under Prof. Saptarshi Ghosh}{CSE Dept. IIT Kharagpur}
...
\end{rSection}
	...
	\vspace*{\fill}
	\begin{flushright}
	\footnotesize Last updated: Jan 15, 2019.
	\end{flushright}
%----------------------------------------------------------------------------------------
%----------------------------------------------------------------------------------------
\end{document}