...
%\begin{rSubsection}{\large Kshitij\parnote{\textbf{\textit{Kshitij}} : Asia's Largest \& IIT Kharagpur's Annual Techno-Management Fest \\}}{\textbf{\large Apr $^{\prime}$16 - May $^{\prime}$17}}{Web Head}{IIT Kharagpur, WB}
%\item Developed from scratch, the original version of \textit{\textbf{VMWare}} sponsored \textit{\textbf{Supply Matrix}} (\textit{Supply Chain Management} based online game) \& \textbf{Woodstock/Forex} (\textit{Virtual Share Market} with real-world data)
%\item Framed website's backend with advance \textit{\textbf{Profile Management System, Online Games, Payment \& Accommodation Portal}} with a \textit{\textbf{REST API}} for swift \& simplified data processing
%\end{rSubsection}

%------------------------------------------------

%\begin{rSubsection}{\large Technology Transfer Group (TTG)\parnote{\textbf{\textit{TTG}} : Official student body under the aegis of SRIC, IIT Kharagpur \\}}{\textbf{\large May $^{\prime}$16 - Jul $^{\prime}$17}}{Web Head}{IIT Kharagpur, WB}
%\item Lead Developer of the \textit{\textbf{Undergraduate(UG) Portal}} aimed at seamless Professor-Student collaboration in the Institute, to be launched by \textit{\textbf{Dean SRIC\parnote{\textbf{\textit{SRIC}} : \textbf{S}ponsored \textbf{R}esearch \textbf{I}ndustrial \textbf{C}onsultancy acts as a link between the Industry and IIT Kharagpur \\}, Prof. Pallab Das Gupta}}
%\item Maintained \textit{\textbf{IP-Portal}\parnote{\textbf{\textit{IP-Portal}} : A portal to monitor patent process at IIT Kharagpur \\}} \& developed official websites of \textit{\textbf{TedXIITKharagpur 2016, 2017}}
%\end{rSubsection}

%------------------------------------------------

%\begin{rSubsection}{\large ACM International Collegiate Programming Contest}{\textbf{\large Aug $^{\prime}$16 - Dec $^{\prime}$16}}{Technical Administrator}{IIT Kharagpur, WB}
%\item Coordinated with \textit{\textbf{CodeChef}} to successfully conduct ACM-ICPC Asia Regionals at Kharagpur
%\item Developed the \textit{\textbf{ACM IIT Kharagpur Chapter}} website \& maintained it's server
%\end{rSubsection}
